 ...
 * @author jose
 */
public class UTR3p extends GenePart {
    ...
    public void setPromoter(List<Motivo> promoter) {
    ...
    public UTR3p(Information start, Information end, List<Information> innerInfo) throws Exception {
